...
$textes[14]["txt"] = "On voit bien que cette démocratie « représentative » ne fonctionne plus du tout. Si, aussitôt élus, les « représentants » peuvent diriger en contradiction avec les aspirations d’une sensible majorité des citoyens, c’est qu’ils ne les « représentent » pas. D’ailleurs, que signifie « représenter » ? Re-présenter, c’est recréer une présence lorsqu’elle est impossible. Ainsi, un représentant de commerce ou un ambassadeur re-présentent leur entreprise ou leur pays. Qu’ils prennent la moindre initiative contre ce qu’ils sont censés…";


$textes[15]["source"] = "http://menace-theoriste.fr/apophenie-illusions-de-perception/";
$textes[15]["txt"] = "Nous sommes des unités informativores. Nous ingurgitons constamment des stimuli que nous analysons pour comprendre le monde. Tous les animaux fonctionnent ainsi, mais nous avons atteint un niveau de raffinement extrême grâce auquel notre espèce réussit des prouesses techniques, artistiques et scientifiques. Nous sommes capables d’identifier les informations pertinentes au milieu du bruit des stimulations tous azimut de notre environnement. Pensons à l’effet cocktail : au milieu d’un brouhaha informe, nous avons la capacité d’isoler…";
...
$textes[30]["txt"] = "Il faut avoir sérieusement forcé sur les boissons fermentées, et se trouver victime de leur propension à faire paraître toutes les routes sinueuses, pour voir, comme s’y emploie le commentariat quasi-unanime, un tournant néolibéral dans les annonces récentes de François Hollande. Sans porter trop hauts les standards de la sobriété, la vérité appelle plutôt une de ces formulations dont Jean-Pierre Raffarin nous avait enchantés en son temps : la route est droite et la pente est forte — mais très descendante (et les freins viennent…";


$textes[31]["source"] = "https://blog.mondediplo.net/2017-09-18-Vivre-et-penser-comme-des-DRH";
$textes[31]["txt"] = "Tu parles ! C’est toute la classe macronienne qui en a d’avance le système glandulaire surmené. Car sous la pellicule fine des ultra-riches, du reste probablement indifférents à cette insane bouillie verbale, s’ils n’en rient pas eux aussi — mais autrement —, il y a toute la petite troupe électorale des wanabees qui, eux, s’y croient à fond. Ils lisent Challenges ou Winner comme jadis on lisait Salut les copains : avec des étoiles dans les yeux, se ruinent le poignet sur des posters dépliables de Xavier Niel, se repassent dans…";


$textes[32]["source"] = "https://fr.wikisource.org/wiki/Lettres_de_mon_moulin/Installation";
$textes[32]["txt"] = "Ce sont les lapins qui ont été étonnés… Depuis si longtemps qu’ils voyaient la porte du moulin fermée, les murs et la plate-forme envahis par les herbes, ils avaient fini par croire que la race des meuniers était éteinte, et, trouvant la place bonne, ils en avaient fait quelque chose comme un quartier général, un centre d’opérations stratégiques : le moulin de Jemmapes des lapins… La nuit de mon arrivée, il y en avait bien, sans mentir, une vingtaine assis en rond sur la plate-forme, en train de se chauffer les pattes à un rayon…";


$textes[33]["source"] = "http://classiques.uqac.ca/contemporains/russell_bertrand/Eloge_oisivete/Eloge_oisivete_texte.html";
$textes[33]["txt"] = "Ainsi que la plupart des gens de ma génération, j’ai été élevé selon le principe que l’oisiveté est mère de tous vices. Comme j’étais un enfant pétri de vertu, je croyais tout ce qu’on me disait, et je me suis doté d’une conscience qui m’a contraint à peiner au travail toute ma vie. Cependant, si mes actions ont toujours été soumises à ma conscience, mes idées, en revanche, ont subi une révolution. En effet, j’en suis venu à penser que l’on travaille beaucoup trop de par le monde, que de voir dans le travail une vertu cause…";


$textes[34]["source"] = "https://fr.wikisource.org/wiki/Le_Droit_à_la_paresse";
$textes[34]["txt"] = "Un poète grec du temps de Cicéron, Antiparos, chantait ainsi l’invention du moulin à eau (pour la mouture du grain) : il allait émanciper les femmes esclaves et ramener l’âge d’or : « Épargnez le bras qui fait tourner la meule, ô meunières, et dormez paisiblement ! Que le coq vous avertisse en vain qu’il fait jour ! Dao a imposé aux nymphes le travail des esclaves et les voilà qui sautillent allègrement sur la roue et voilà que l’essieu ébranlé roule avec ses raies, faisant tourner la pesante pierre roulante. Vivons de la vie…";


$textes[35]["source"] = "https://fr.wikisource.org/wiki/Le_Droit_à_la_paresse";
$textes[35]["txt"] = "Si, en diminuant les heures de travail, on conquiert à la production sociale de nouvelles forces mécaniques, en obligeant les ouvriers à consommer leurs produits, on conquerra une immense armée de forces de travail. La bourgeoisie, déchargée alors de sa tâche de consommateur universel, s’empressera de licencier la cohue de soldats, de magistrats, de figaristes, de proxénètes, etc., qu’elle a retirée du travail utile pour l’aider à consommer et à gaspiller. C’est alors que le marché du travail sera débordant, c’est alors qu’il…";


$textes[36]["source"] = "https://fr.wikisource.org/wiki/Le_Droit_à_la_paresse";
$textes[36]["txt"] = "Une étrange folie possède les classes ouvrières des nations où règne la civilisation capitaliste. Cette folie traîne à sa suite des misères individuelles et sociales qui, depuis des siècles, torturent la triste humanité. Cette folie est l’amour du travail, la passion moribonde du travail, poussée jusqu’à l’épuisement des forces vitales de l’individu et de sa progéniture. Au lieu de réagir contre cette aberration mentale, les prêtres, les économistes, les moralistes, ont sacro-sanctifié le travail. Hommes aveugles et bornés,…";
