...
var cur_col_err = "#aa1d1d";                                                    //couleur du curseur en cas d'erreur
...
function test(e)
{
  ...
  //if (val != le_texte.substr(0,val.length))  // ligne commentée pour la version MacOs
  {
    ...
    document.getElementById("txt").style.backgroundColor = "#d05c5c";           //on met la zone da frappe en rouge
  ...
  else                                                                          //sinon si le texte est équivalent
  {
    ...
    document.getElementById("txt").style.backgroundColor = "#202020";           //et on met la zone de frappe un peu plus claire
    document.getElementById("txt").style.color = "#c6c6c6";                     //on dÃ©grise le texte dans la zone de frappe
    ...
    if (val.length >= nb_car)                                                   //si on a atteint le nombre de caractères à frapper
    {
      ...
      document.getElementById("txt").style.color = "#909090";         //on grise le texte dans la zone de frappe
      // document.getElementById("txt").style.backgroundColor = "#004600";         //on grise la zone de frappe
