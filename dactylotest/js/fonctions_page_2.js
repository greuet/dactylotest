...
function new_text(a)
{
  ...
  document.getElementById("txt").style.backgroundColor = "#202020";             //on met le fond de la zone de frappe un peu plus claire
...
function options()
{
  ...
  for (var i=0 ; i<le_texte.length ; i++)
  {
    if (document.getElementById("no_brk_spc_display").checked == true && tt[i] == " ")
      tt[i] = '<span style="background-color:#424242"><span id="car'+(i+1)+'">'+tt[i]+'</span></span>';
    else
...
//😁😂😃😄😅😆😇😈😉😊😋😌😍😎😏😐😒😓😔😖😘😚😜😝😞😠😡😢😣😥😨😩😪😫😭😰😱😲😳😵😶😷😸😹😺😻😼😽😾😿🙀
    ...
    result +=  "Temps : "+ total_time +nl
	      ...
	      +'Précision : <span id="precision_col" style="color:#aa1d1d"><strong>'+precision+' %</strong></span> :('+nl
	      ...
	      +'Mots par minute : <span id="mpm_col" style="color:#b65e07"><strong>'+mpm+"</strong></span>"+nl
	      +'Fluidité : <span id="fl_col" style="color:#aa1d1d"><strong>'+fl+' %</strong></span>'+nl;
  ...
  if (precision >= 99)
  {
    ...
    result = result.replace('id="precision_col" style="color:#aa1d1d"','id="precision_col" style="color:#184c06"'); //et on passe la précision en vert
  }
  else if (precision > 96)
  {
    ...
    result = result.replace('id="precision_col" style="color:#aa1d1d"','id="precision_col" style="color:#b65e07"');//et on passe la précision en orange
  }
  else
  ...
  if (mpm >= 50)
  {
    ...
    result = result.replace('id="mpm_col" style="color:#b65e07"','id="mpm_col" style="color:#184c06"');          //et on passe la vitesse en vert
  }
  ...
  if (fl >= 65)
  {
    ...
    result = result.replace('id="fl_col" style="color:#aa1d1d"','id="fl_col" style="color:#184c06"');               //mise en vert parce que c'est bien
  }
